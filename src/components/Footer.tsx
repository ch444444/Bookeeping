...
const footerLinks = {
  ...
  Services: [
    { href: "/services", label: "Monthly Bookkeeping" },
    { href: "/services", label: "Cleanup & Catch-Up" },
    ...
    <footer className="bg-text-dark text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex flex-col items-center text-center gap-10">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-10 sm:gap-16">
